...
public class Kafka11Example {
    public static void main(String[] args) throws Exception {
        // parse input arguments
        args=new String[]{"--input-topic","test","--output-topic","testd","--bootstrap.servers","192.168.139.111:9092","--zookeeper.connect","192.168.139.111:2181","--group.id","test-consumer-group"};
