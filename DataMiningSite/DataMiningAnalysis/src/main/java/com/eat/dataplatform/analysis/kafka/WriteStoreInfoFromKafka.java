...
public class WriteStoreInfoFromKafka {
    public static void main(String[] args) throws Exception {
        // parse input arguments
        //args=new String[]{"--input-topic","test12","--output-topic","testd","--bootstrap.servers","192.168.10.25:9092","--zookeeper.connect","192.168.10.25:2181","--group.id","test"};
        ...
        input.addSink(
                new FlinkKafkaProducer011<>(
                        ...
                        new KafkaEventSchema(),
                        parameterTool.getProperties()));
        env.execute("Store info into kafka");
    }
